...
const imgui_root := "res://Game/Code/ThirdParty/imgui-godot/data/ImGuiRoot.tscn"
...
class ImGuiExporter extends EditorExportPlugin:
    ...
    const gdext_resource := "res://Game/Code/ThirdParty/imgui-godot/imgui-godot-native.gdextension"
    ...
    func _export_begin(features: PackedStringArray, is_debug: bool, path: String, flags: int) -> void:
        ...
        if not export_imgui:
            ...
            var da := DirAccess.open("res://Game/Code/ThirdParty/imgui-godot")
    ...
    func _export_file(path: String, type: String, features: PackedStringArray) -> void:
        if not export_imgui:
            if path.contains("res://Game/Code/ThirdParty/imgui-godot"):
                skip()

...
const csharp_controller := "res://Game/Code/ThirdParty/imgui-godot/ImGuiGodot/ImGuiController.cs"
const csharp_sync := "res://Game/Code/ThirdParty/imgui-godot/ImGuiGodot/ImGuiSync.cs"

func _enter_tree_game():
